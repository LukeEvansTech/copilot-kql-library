...
- **Microsoft Purview audit**: <https://compliance.microsoft.com/auditlogsearch> — paste KQL into the *Search* field, ensure the time range covers your Copilot activity.
